...
@Hack.Registration(name = "Auto Armour", description = "replaces armour pieces if a piece pops.", category = Hack.Category.COMBAT, isListening = false)
