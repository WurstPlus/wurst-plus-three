 ...
 */
@Hack.Registration(name = "AntiVoid", description = "stops dumb ppl (you) falling into the void", color = 0xB135D3, category = Hack.Category.MISC, priority = HackPriority.High)
