...
public class Crosshair extends Hack {
    ...
    @Override
    public void onTick(){
        shouldMove = moveError.getValue() && (mc.player.motionX > 0.1 || mc.player.motionY > 0.1 || mc.player.motionZ > 0.1 || mc.player.motionX < -0.1 || mc.player.motionY < -0.1 || mc.player.motionZ < -0.1);
    }
