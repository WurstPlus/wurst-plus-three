...
public class HudLagNotifier extends HudElement {
    ...
    @Override
    public int getWidth(){
        return WurstplusThree.GUI_FONT_MANAGER.getTextWidth(length);
    }
    ...
    public void onRender2D(Render2DEvent event){
        ...
        if(WurstplusThree.SERVER_MANAGER.isServerNotResponding()){
            WurstplusThree.GUI_FONT_MANAGER.drawStringWithShadow(length, getX(), getY(), HudEditor.INSTANCE.fontColor.getValue().hashCode());
        }
    }
}
