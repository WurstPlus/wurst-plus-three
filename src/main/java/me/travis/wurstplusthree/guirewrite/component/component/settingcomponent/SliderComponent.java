...
public class SliderComponent extends Component {
    ...
    public void renderComponent() {
        ...
        WurstplusThree.GUI_FONT_MANAGER.drawStringWithShadow(isInt() ? this.setI.getName() + " " + ChatFormatting.GRAY + (int) this.setI.getValue() : this.setD.getName() + " " + ChatFormatting.GRAY + this.setD.getValue(), parent.parent.getX() + WurstplusGuiNew.SUB_FONT_INDENT, parent.parent.getY() + offset + 3 + WurstplusGuiNew.MODULE_SPACING, -1);
    }
    ...
    public void updateComponent(int mouseX, int mouseY) {
        ...
        if (isInt()) {
            ...
            renderWidth = (widthTest) * (float)(setI.getValue() - min) / (max - min) + WurstplusGuiNew.MODULE_WIDTH_OFFSET;
            ...
            renderWidth = (widthTest) * (setD.getValue() - min) / (max - min) + WurstplusGuiNew.MODULE_WIDTH_OFFSET;
